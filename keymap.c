...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LTR] = LAYOUT(
          ...
          QMARK,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_TRNS,  TTURBO,      MS_BTN1, MS_BTN2,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,   EMARK,
    ...
    [_NAV] = LAYOUT(
        ...
        ________,________, KC_LEFT, KC_DOWN, KC_RGHT,________,                                        ________, KC_LCMD, KC_LOPT, KC_LSFT, KC_LCTL,________,
         QK_BOOT,  SWRD_L,  SSYM_L,________,  SSYM_R,  SWRD_R, KC_TRNS, KC_TRNS,     KC_TRNS, KC_TRNS,________,________,________,________,________,________,
    ...
    // Layer: Controls 1
    [_CT1] = LAYOUT(
         KC_VOLU,    HIDE,   DESK1,   DESK2,   DESK3,   RCAST,                                        ________,________,________,________,________, KC_BRIU,
    ...
    [_CT2] = LAYOUT(
        ________, UG_VALD, UG_VALU, UG_PREV, UG_NEXT, UG_TOGG,                                             DND,TO(_SPC),________,________,________,________,
         QK_BOOT, UG_SPDD, UG_SPDU, UG_HUED, UG_HUEU,________,                                             SCR,TO(_NUM),________,________,________,________,
    ...
    // Layer: Touchpad
    [_MS1] = LAYOUT(
        ________,________,________,________,________,________,                                         MS_BTN1, MS_BTN2,________,________,________,________,
        ________,________,________,________,________,________,                                          TTURBO,________,________,________,________,________,
